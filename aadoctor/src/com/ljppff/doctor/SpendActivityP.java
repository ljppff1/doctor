...
public class SpendActivityP extends BaseActivity1 {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_spendp);
		initView();
	...
	private Handler handler = new Handler() {
		public void handleMessage(android.os.Message msg) {
			...
			case 2:
				mTvSpendText.setText(downa+"");
					startActivity(new Intent(getApplicationContext(), MainActivityP.class));
