...
public class PlayActivity1 extends Activity implements OnClickListener,
	...
	// int ss = PlayActivity1.this.getRequestedOrientation();
		   if(PlayActivity1.this.getRequestedOrientation()==ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE){
			   PlayActivity1.this.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);
           }else if(PlayActivity1.this.getRequestedOrientation()==ActivityInfo.SCREEN_ORIENTATION_PORTRAIT){
        	   PlayActivity1.this.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE);
           }
		setListener();
	...
	public void onPrepared(MediaPlayer arg0) {
		...
		if (urls.get(flag).startsWith("http")) {
			videoView.setBufferSize(1024 * 600);
		} else {
...
/*        int o=getRequestedOrientation();//ªÒ»° ÷ª˙µƒ≥ØœÚ
        switch (o) {
        case ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE:
          //  editText.setText("µ±«∞∆¡ƒª≥ØœÚŒ™£∫ ∫·∆¡");
			   PlayActivity1.this.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);
